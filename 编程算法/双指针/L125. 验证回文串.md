...
public class L125CalidPalindrome {
    ...
    static class Solution {
        public boolean isPalindrome(String s) {
            ...
            int sizeOfLettle = characterList.size();
            for (int i = 0; i < sizeOfLettle / 2; i++) {
                if (characterList.get(i) != characterList.get(sizeOfLettle - i - 1)){
                    return false;
                }
            }
            return true;
